...
import ru.yarsu.web.models.ContribDeleteVM
import ru.yarsu.web.templates.ContextAwareViewRender
import java.util.UUID

class ContribDeleteHandler(val htmlView: ContextAwareViewRender, val projectsStorage: ProjectsStorage): HttpHandler {
    override fun invoke(request: Request): Response {
        ...
        val model = ContribDeleteVM(listProjects, formattedId)
