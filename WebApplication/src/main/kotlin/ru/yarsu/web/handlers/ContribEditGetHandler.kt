...
import ru.yarsu.web.models.ContribEditVM
import ru.yarsu.web.templates.ContextAwareViewRender
import java.util.UUID

class ContribEditGetHandler(val htmlView: ContextAwareViewRender, val projectsStorage: ProjectsStorage): HttpHandler {
    override fun invoke(request: Request): Response {
        ...
        val vznos = projectsStorage.getVznosById(formattedId) ?: return Response(Status.NOT_FOUND)
        val listProjects = projectsStorage.getAllProjects()
        val model = ContribEditVM(listProjects, vznos, name)
