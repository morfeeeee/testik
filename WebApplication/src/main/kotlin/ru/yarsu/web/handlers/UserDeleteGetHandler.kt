...
class UserDeleteGetHandler(val htmlView: ContextAwareViewRender, val projectsStorage: ProjectsStorage, val userStorage: UserStorage): HttpHandler {
    override fun invoke(request: Request): Response {
        ...
        val model = UserDeleteVM(listProjects, user.nameUser)
