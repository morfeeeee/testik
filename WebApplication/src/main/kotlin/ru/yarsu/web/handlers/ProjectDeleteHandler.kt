...
import ru.yarsu.web.models.ProjectDeleteVM
import ru.yarsu.web.templates.ContextAwareViewRender

class ProjectDeleteHandler(val htmlView: ContextAwareViewRender, val projectsStorage: ProjectsStorage): HttpHandler {
    override fun invoke(request: Request): Response {
        ...
        val project: Projects = projectsStorage.getByName(name)
            ?: return Response(Status.NOT_FOUND)
        val model = ProjectDeleteVM(listProjects, project.name)
